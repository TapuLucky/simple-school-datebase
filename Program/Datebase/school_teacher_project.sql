...
CREATE TABLE `teacher_project` (
  ...
  CONSTRAINT `FK_teacher_project` FOREIGN KEY (`teacher_id`) REFERENCES `teacher` (`teacher_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `FK_teacher_project2` FOREIGN KEY (`project_id`) REFERENCES `project` (`project_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
INSERT INTO `teacher_project` VALUES ('Th001','P1'),('Th002','P2'),('Th003','P3');
...
-- Dump completed on 2019-04-12 20:24:46
