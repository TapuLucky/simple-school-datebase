...
CREATE TABLE `course` (
  ...
  CONSTRAINT `FK_teacher_course` FOREIGN KEY (`teacher_id`) REFERENCES `teacher` (`teacher_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
INSERT INTO `course` VALUES ('C1','T101','Th001','物联网'),('C2','T201','Th002','数据库'),('C3','T301','Th003','体系结构');
